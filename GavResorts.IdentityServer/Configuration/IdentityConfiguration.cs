...
namespace GavResorts.IdentityServer.Configuration
{
    public class IdentityConfiguration
    {
        ...
        public static IEnumerable<ApiScope> ApiScopes =>
            ...
            new ApiScope("gavresorts", "VShop Server"),
        ...
        public static IEnumerable<Client> Clients =>
            ...
            new Client
            {
                ...
                RedirectUris = {"https://localhost:2222/signin-oidc"}, //login
                PostLogoutRedirectUris = {"https://localhost:2222/signout-callback-oidc"}, //logout
